...
<body>
  ...
  <script>
    ...
    //20.SNSのリンク
    const sns = {
      tw: document.querySelector('.link_tw'),
      fb: document.querySelector('.link_fb'),
      insta: document.querySelector('.link_insta'),
      linkedin: document.querySelector('.link_linkedin')
    }
    snsLink(sns.tw, user_info.tw)
    snsLink(sns.fb, user_info.fb)
    snsLink(sns.insta, user_info.insta)
    snsLink(sns.linkedin, user_info.linkedin)
  </script>
